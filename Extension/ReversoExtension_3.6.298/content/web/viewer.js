...
// TODO FIX By Aleksey Romanov;
// Error open pdf from http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.367.5092&rep=rep1&type=pdf
self.requestedURL_ReversoExtension = location.href;
// END FIX By Aleksey Romanov;
  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const PDFViewerApplication = {
        ...
        async run(config) {
          ...
          // todo: FIX Aleksey Romanov
          // validateFileURL(file);
          // todo: END FIX Aleksey Romanov
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFViewer {
        ...
        get pageViewsReady() {
          return (
            this._pagesCapability.settled && this._pages.every((pageView) => pageView?.pdfPage)
          );
        }
        get renderForms() {
        ...
        decreaseScale({ drawingDelay, scaleFactor, steps } = {}) {
          ...
          if (scaleFactor > 0 && scaleFactor < 1) {
            ...
            do {
              newScale =
                Math.floor((newScale / _ui_utils.DEFAULT_SCALE_DELTA).toFixed(2) * 10) / 10;
